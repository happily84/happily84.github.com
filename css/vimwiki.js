var kwiki = {
    ...
    loadCmt: function(provider) {
        ...
        if (provider == 'disqus') {
            ...
            theJS = 'http://seanzhang.disqus.com/embed.js';
...
var HOST_ROOT = 'http://seanzhang.tk/',
...
$(document).ready(function() {
    if (window.innerWidth >= 460) {
        var toggler = $('<div class="toggler" title="click to show/hide, shift+Z to hide or open">Table of Content</div>'),
        toc = $('.toc');
